...
#include <stdio.h>	/* файл стандартных функций ввода/вывода          */


/*
	Количество единиц памяти (символов), используемых для хранения
	множества. При переносе на Эльбрус установить 4.
*/
