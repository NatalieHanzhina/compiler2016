...
extern FILE *d;		/* для отладки 					*/
   ...
   /* РЕШЕНИЯ ВТОРОЙ СЕССИИ ПЕРМСКОГО ОБЛАСТНОГО СОВЕТА -- В ЖИЗНЬ ! */
...
/*======================== ШМОТОК ДЛЯ ОТЛАДКИ: =========================*/
#ifdef RDB
fprintf(d,"перехожу на следующее имя в строке: %s; позиция %d",addrname,
								loccount);
fprintf(d," наше имя: %s\n",name);
#endif
/*====================== КОНЕЦ ШМОТКА ДЛЯ ОТЛАДКИ! =====================*/
